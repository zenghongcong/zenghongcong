<template>
	<div class="music">
		...
		<div class="mask-bg" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVeFn8MQdvCclfUzf00HJ4K8uLrTlLDsyU_DZpqs6f75k6Nd7r);"></div>
		<header>
