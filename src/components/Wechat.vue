...
.wechat .footer span:first-child {
  top: 0.06rem;
  left: 2.5rem;
  background-image: url(../../static/assets/footer-arrow1.png);
  transform: rotate(90deg);
}

.wechat .footer span:last-child {
  right: 2.5rem;
  background-image: url(../../static/assets/footer-arrow2.png);
  transform: rotate(-90deg);
}
